...
SUPABASE_KEY = os.getenv("SUPABASE_KEY")  # Użyj sb_secret_... dla pełnych uprawnień
SUPABASE_HEADERS = {
    "apikey": SUPABASE_KEY,
...
def ensure_supabase_table():
    ...
    try:
        ...
        # Jeśli nie istnieje — utwórz ją przez SQL
        sql = """
        ...
        if ddl_response.status_code in (200, 204):
            logger.info("✅ Tabela 'licenses' została utworzona.")
        else:
            # Alternatywa: ręczne tworzenie przez REST (jeśli RPC nie działa)
            logger.warning("⚠️ Nie udało się utworzyć tabeli automatycznie. Utwórz ją ręcznie w Supabase Studio.")
...
# === PANEL ADMINA ===
# ... (taki sam jak w poprzedniej wiadomości — z Chart.js i POST-redirect-GET)
# Ze względu na limit długości, zakładam, że używasz poprzedniego szablonu HTML
